...
import com.example.myapplication.swipeDrawer_view.AnimThread;
import com.example.myapplication.swipeDrawer_view.OnDrawerChange;
import com.example.myapplication.swipeDrawer_view.OnDrawerState;
import com.example.myapplication.swipeDrawer_view.OnDrawerSwitch;
import com.example.myapplication.swipeDrawer_view.ViewUtils;
...
public class SwipeDrawer extends ViewGroup{
    ...
    private void attrInit(Context context, AttributeSet attr) {
        if (attr != null) {
            ...
            int getMode = mode;
            int getMask = mask;
            int getLeftMode = leftMode;
            int getTopMode = topMode;
            int getRightMode = rightMode;
            int getBottomMode = bottomMode;
            int getMainType = mainType;
            int getLeftType = leftType;
            int getTopType = topType;
            int getRightType = rightType;
            int getBottomType = bottomType;
            int getMainOpen = mainOpen;
            float getShrinkRange = shrinkRange;
            int getDragDamping = dragDamping;
            int getDragRange = dragRange;
            int getDragSlop = dragSlop;
            int getMaxDragSize = maxDragSize;
            int getDuration = duration;
            int getMaskColor = maskColor;
            int getInterpolatorId = -1;
            leftDragOpen = leftDragOpen;
            topDragOpen = topDragOpen;
            rightDragOpen = rightDragOpen;
            bottomDragOpen = bottomDragOpen;
            showLayout = showLayout;
            autoClose = autoClose;
            maskClose = maskClose;
            dragClose = dragClose;
            scrollOuterDrag = scrollOuterDrag;
            parentId = parentId;
            mainScrollId = mainScrollId;
            leftScrollId = leftScrollId;
            topScrollId = topScrollId;
            rightScrollId = rightScrollId;
            bottomScrollId = bottomScrollId;
            mainId = mainId;
            leftId = leftId;
            topId = topId;
            rightId = rightId;
