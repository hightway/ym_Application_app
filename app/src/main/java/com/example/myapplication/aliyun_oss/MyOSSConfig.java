...
public class MyOSSConfig {
    ...
    // 访问的endpoint地址
    public static final String OSS_ENDPOINT = "http://oss-cn-guangzhou.aliyuncs.com";
    //callback 测试地址
    ...
    public static final String BUCKET_NAME = "test-maoyu";

    //public static final String OSS_ACCESS_KEY_ID = "STS.NV47cEaz4fs3CGF8iiihiW3dz";
    //public static final String OSS_ACCESS_KEY_SECRET = "Fp6BaSekDTf8DgYdQiqZYEHBn591Yd4yy8DjbmXm2PWp";
