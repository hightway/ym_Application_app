...
public class RealtimeBlurView extends View {
    ...
    public RealtimeBlurView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RealtimeBlurView_New);
        mBlurRadius = a.getDimension(R.styleable.RealtimeBlurView_New_realtimeBlurRadius,
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics()));
        mDownsampleFactor = a.getFloat(R.styleable.RealtimeBlurView_New_realtimeDownsampleFactor, 4);
        mOverlayColor = a.getColor(R.styleable.RealtimeBlurView_New_realtimeOverlayColor, 0x55FFFFFF);
        a.recycle();
    ...
    protected void drawBlurredBitmap(Canvas canvas, Bitmap blurredBitmap, int overlayColor) {
        ...
        canvas.drawRoundRect(mRectDst, 180f, 180f, mPaint);
    }
